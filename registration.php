       ...
       <section class="wrapper">
           <div class="container">
               ...
               <form class="form-horizontal" method="post" action="add_Patient.php">
                   ...
                   <div class="form-group">
                       <label class="control-label col-sm-2" for="numero">Numéro de téléphone<span class="required">*</span></label>
                       <div class="col-sm-10">
                           <input type="number" class="form-control" id="numero" placeholder="Enter numero de telephone" name="numero">
                       </div>
                   </div>
                   <div class="form-group">
